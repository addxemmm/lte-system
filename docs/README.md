...
| `MIGRATION.md` | 旧 Python 版 → Go 版对照 |
| `images/` | 架构图（`ltesystem.png` 全量 / `ltesystem-easy.png` 简版）与写卡参数图 |
| `samples/` | 真机样本：`epc-ue-attached.log`（ue3 成功入网日志）、`atr-*.txt`（白卡 ATR） |
| `legacy/` | 2023 年原始中文文档（PDF/MD，仅存档，以本目录文档为准） |
