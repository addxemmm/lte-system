...
| [API.md](API.md) | **v1 标准接口**完整参考（包络/状态码/错误码/新旧对照） / Complete reference for the **v1 standard API** (envelope/status codes/error codes/old-new mapping) |
| [API_LEGACY.md](API_LEGACY.md) | 旧版根路径接口逐字文档（已冻结） / Verbatim docs for the legacy root-path API (frozen) |
