...
v1.x Python + srsLTE，手工容器，`legacy-python-workspace/` 存档saved profile。见 `docs/legacy/`。不再维护；无安全修复。
v1.x Python + srsLTE, manual container, `legacy-python-workspace/` archive. See `docs/legacy/`. Not maintained; no security fixes.
